...
import ExcalidrawApp, { COLLAB_ENABLED } from "../App";
 ...
 */
// 协作入口隐藏(COLLAB_ENABLED=false)时不挂载 <Collab>,相关测试随之跳过
const describeCollab = COLLAB_ENABLED ? describe : describe.skip;

describeCollab("collaboration", () => {
